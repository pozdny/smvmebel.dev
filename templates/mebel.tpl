    ...
    <div class="content">
        <div class="modal-body">
            <div class="product_info">
                <div class="product_images">
                    <div class="main_image">
                        <a class="colorbox" title="Корпусная мебель" href="img/catalog/empl/big/1.jpg">
                            <div class="zoom">
                ...
                <div class="right_block">
                    <h3 class="modal-title">Корпусная мебель</h3>
                    <p>
            ...
            <div class="price_list">
                <h3 class="modal-title">Прайс-лист на корпусную мебель</h3>
