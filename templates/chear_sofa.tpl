    ...
    <div class="content">
        <div class="modal-body">
            <div class="product_info">
                <div class="product_images">
                    <div class="main_image">
                        <a class="colorbox" title="Диваны, пуфы" href="img/catalog/empl/big/1.jpg">
                            <div class="zoom">
                ...
                <div class="right_block">
                    <h3 class="modal-title">Диваны, пуфы</h3>
                    <p>
            ...
            <div class="price_list">
                <h3 class="modal-title">Прайс-лист на модели диванов, пуфов</h3>
